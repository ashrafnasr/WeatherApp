...
import com.example.a2018.weatherapp.Adapter.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            ...
                            //Create a new instance of FusedLocationProviderClient for use in this Activity.
    ...
    //Used To Set The Accuracy Of The Location
    private void buildLocationRequest() {
        locationRequest = new LocationRequest();
        //Get The Highest Accuracy Of The Location
